...
namespace GameFramework
{
    ...
    internal sealed partial class EventPool<T> where T : BaseEventArgs
    {
        ...
        private readonly Dictionary<object, LinkedListNode<EventHandler<T>>> m_CacheNodes;
        ...
        private EventHandler<T> m_DefaultHandle;
        ...
        public EventPool(EventPoolMode mode)
        {
            ...
            m_CacheNodes = new Dictionary<object, LinkedListNode<EventHandler<T>>>();
        ...
        /// <param name="realElapseSeconds">真是流逝时间，以秒为单位</param>
        ...
        public void Subscribe(int id, EventHandler<T> handler)
        {
            ...
            else if ((m_EventPoolMode & EventPoolMode.AllowMultiHandle) != EventPoolMode.AllowMultiHandle)
            {
        ...
        public void Unsubscribe(int id, EventHandler<T> handler)
        {
            ...
            {
                foreach (KeyValuePair<object, LinkedListNode<EventHandler<T>>> cachedNode in m_CacheNodes)
                {
                ...
                if (m_TempNodes.Count > 0)
                {
                    ...
                    {
                        m_CacheNodes[cachedNode.Key] = cachedNode.Value;
                    }
                    m_TempNodes.Clear();
                }
            }
        ...
        private void HandleEvent(object sender, T e)
        {
            ...
            if (m_EventHandlers.TryGetValue(e.Id, out range))
            {
                ...
                {
                    m_CacheNodes[e] = current.Next != range.Terminal ? current.Next : null;
                    current.Value(sender, e);
                    current = m_CacheNodes[e];
                }
                m_CacheNodes.Remove(e);
            }
            else if (m_DefaultHandle != null)
            {
                m_DefaultHandle(sender, e);
            }
